...
const streamToMux = (context) => {
    return new Promise(async (resolve, reject) => {
        ...
        const child = childProcess.spawn(
            ...
            ['-re', '-i', `${inputAbsolutePath}`, '-r', '30', '-c:v', 'libx264', '-x264-params', 'keyint=60:scenecut=0', '-preset', 'fast', '-b:v', '5M', '-maxrate', '6M', '-bufsize', '3M', '-threads', '4', '-f', 'flv', 'rtmp://global-live.mux.com:5222/app/5ac28812-8320-0c76-2ba2-313288af035f'],
            {
